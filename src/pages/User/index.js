...
export default class User extends Component {
  ...
  handleOnEndReached = async () => {
    ...
    this.fetchStars(nextPage);
  };

  handleOnRefreshList = async () => {
      ...
      <Container>
        ...
        {loading ? (
          ...
          <Stars
            ...
            onRefresh={this.handleOnRefreshList}
            ...
            renderItem={({ item }) => (
              <Starred>
                ...
                <RepositoryButton onPress={() => this.handleNavigate(item)}>
                  <RepositoryButtonText>Detalhes</RepositoryButtonText>
                </RepositoryButton>
              </Starred>
            )}
          />
